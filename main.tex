  	...
  	{\begin{tikzpicture}[remember picture, overlay]
    	\node[yshift=-3cm] at (current page.north west)
      		{\begin{tikzpicture}[remember picture, overlay]
				...
				\node[anchor=east, xshift=0.9\paperwidth, rectangle,  rounded corners=20pt, inner sep=11pt, fill=MidnightBlue] {\color{white} {\fontsize{48}{60}\selectfont\chapterlabel}#1};
    		\end{tikzpicture}};
   	\end{tikzpicture}
}
...
\newenvironment{code}{\begin{minted}[frame=single, fontsize=\small]{c}}{\end{minted}}
