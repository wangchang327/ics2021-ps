...
\usepackage{float}
\usepackage{tikz}
\usetikzlibrary{shapes.symbols, backgrounds, matrix, calc, arrows, math, arrows.meta, shapes.gates.logic.US, shapes.gates.logic.IEC}
\usepackage{minted}
...
\newenvironment{problems}{%
	\begin{ExerciseList}
		...
		\vbox{\unvbox\all@Answerbox\section*{参考答案\zhnum{chapter}}\unvbox\@Exercisebox\vskip\z@}%
...
\begin{document}
	\begin{titlepage}
		...
		\begin{minipage}{0.35\linewidth}
			\begin{flushright}
				\Large \textbf{汇编：} 王畅 \\
    			\href{mailto:wchang@pku.edu.cn}{\texttt{wchang@pku.edu.cn}}
			\end{flushright}
		\end{minipage}%
		\begin{minipage}{0.02\linewidth}
			\ \rule{1pt}{56pt}
		\end{minipage}
		\begin{center} \href{https://www.pku.edu.cn/}{\includegraphics[height=54pt]{logo.eps}} \end{center}
		\titlepagedecoration
	\end{titlepage}
	\newpage
	\thispagestyle{empty}
	...
	\vfill
	\begin{flushleft}
		\large 编者仅做了汇编和微小的改动，主要内容均来源于往年计算机系统导论课程，请悉知。
	\end{flushleft}
